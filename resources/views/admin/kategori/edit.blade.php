            ...
            <form action="{{ route('admin.kategori.update', $kategori->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input
                        ...
                        class="w-full border {{ $errors->has('nama_kategori') ? 'border-red-400 bg-red-50' : 'border-slate-200' }} rounded-xl px-4 py-2.5 text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                        autofocus
                    >
                    @error('nama_kategori')
